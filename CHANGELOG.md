...
## [0.1.0](https://github.com/i-am-logger/rust-template/releases/tag/v0.1.0) - 2026-08-10

### Chore

- sync CI, caching and badge conventions from rav ([#2](https://github.com/i-am-logger/rust-template/pull/2))
